...
public class AllNewsDetailsApdater extends RecyclerView.Adapter<AllNewsDetailsApdater.MyNoteHolder>{
    Context context;
    ...
    public AllNewsDetailsApdater(Context context, String[] title, String[] description , String[] date , String[] url, long[] id) {
    ...
    @Override
    public AllNewsDetailsApdater.MyNoteHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.item_latestnews,parent,false);
        return new AllNewsDetailsApdater.MyNoteHolder(view);
    }

    @Override
    public void onBindViewHolder(AllNewsDetailsApdater.MyNoteHolder holder, final int position) {
       ...
       /* if (position==0)
        {
            ...
            *//*click on the cardview*//*
            ...
            Glide.with(context).load(url[position]).into(holder.iv_url);
